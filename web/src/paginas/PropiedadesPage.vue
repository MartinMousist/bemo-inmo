...
import FiltroDesplegable from '../componentes/FiltroDesplegable.vue';
...
function limpiarCampos(...campos: Array<keyof typeof filtros.value>) {
  for (const c of campos) filtros.value[c] = '';
}
  ...
  <div class="stack">
    ...
    <div class="barra-filtros">
      ...
      >
        ...
        <p v-if="(filtros.precioMin || filtros.precioMax) && !filtroOperacion" class="nota-panel">
