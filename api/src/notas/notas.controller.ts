 ...
 *
 * Sin `@Roles` en lectura y alta: un asesor tiene que poder anotar lo que habló
 * con un inquilino, que es justamente el caso de uso. Lo único restringido es
 * borrar: una nota es el registro de algo que pasó.
 */
@Controller('notas')
